function Out_mvMSE=RCmvMSE_var(X,sm,sr,stau,Scale)
%
% To improve the stabily and reliabilty of multivaraite multiscale entropy (mvMSE) based on variance (mvMSE_var), especially for short signals, we proposed refined composite mvMSE (RCmvMSE_var). In RCmvMSE_var, for scale
%factor tau, tau different multivaraite time series, corresponding to different starting points of the coarse-graining process are created and the RCmvMSE_var value is defined based on
